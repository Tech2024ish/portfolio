      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-2xl p-8">
            <h3 className="text-xl font-bold text-white mb-2">{t.contact.infoTitle}</h3>
            <p className="text-gray-400 text-sm mb-8 leading-relaxed">{t.contact.infoSubtitle}</p>

            <div className="space-y-6">
              {/* Location */}
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 bg-teal-900/50 rounded-xl flex items-center justify-center text-teal-400 flex-shrink-0">
                ...
                <div>
                  <p className="text-sm font-semibold text-white">{t.contact.locationLabel}</p>
                  <p className="text-gray-400 text-sm mt-0.5">{t.contact.locationValue}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-sm font-semibold text-white">{t.contact.emailInfoLabel}</p>
                  <a href={`mailto:${t.contact.emailInfoValue}`} className="text-teal-400 text-sm mt-0.5 hover:underline">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href={`tel:${t.contact.phoneValue.replace(/\s/g, '')}`} className="text-teal-400 text-sm mt-0.5 hover:underline">

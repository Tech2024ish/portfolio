...
function ServiceCard({ icon, title, description, index }) {
  ...
  return (
    <div
      ...
      className={`bg-gray-800 border border-gray-700 rounded-2xl p-6 hover:border-teal-500 hover:shadow-lg hover:shadow-teal-900/20 transition-all duration-500 ${
    ...
    <section id="services" className="py-24 bg-gray-950">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-4xl font-extrabold text-white">{t.services.title}</h2>

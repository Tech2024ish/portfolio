export const translations = {
  en: {
    ...
    hero: {
      ...
      typewords: ["CS Student @ UR-CST", "Full-Stack Developer", "Backend Developer", "Python Developer", "ML/AI Enthusiast", "Problem Solver"],
  ...
  fr: {
    ...
    hero: {
      ...
      typewords: ["Étudiant CS @ UR-CST", "Développeur Full-Stack", "Développeur Backend", "Développeur Python", "Passionné de ML/IA", "Solutionneur de Problèmes"],
  ...
  rw: {
    ...
    hero: {
      ...
      typewords: ["Umunyeshuri wa CS @ UR-CST", "Umuprogrameri Wuzuye", "Umuprogrameri wa Backend", "Umuprogrameri wa Python", "Ukunzwe ML/AI", "Gukemura Ibibazo"],
